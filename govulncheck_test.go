...
func TestFormatPluginSource(t *testing.T) {
	...
	if got := formatPluginSource("0.1.4", "", nil); got != "trivy-plugin-govulncheck 0.1.4 (govulncheck unknown)" {
	...
	got := formatPluginSource("0.1.4", "v1.0.0", dbInfo)
	if got != "trivy-plugin-govulncheck 0.1.4 (govulncheck v1.0.0) (vuln DB: https://vuln.go.dev, last modified: 2024-01-15T12:00:00Z)" {
